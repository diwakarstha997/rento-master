...
class RoomForm extends Form {
  ...
  schema = {
    ...
    squareFeet: Joi.number()
      ...
      .required()
      .label("Square Feet"),
    description: Joi.string().min(15).max(500).required().label("Description"),
  ...
  doSubmit = async () => {
    try {
      const response = await saveRoom(this.state.data);
      console.log("Form submitted", response);
      this.props.history.replace("/RoomOwner/MyRooms");
          ...
          <form onSubmit={this.handleSubmit} encType="multipart/form-data">
            <div style={{ margin: "0 5% 0 5%" }}>
              ...
              <div>
                ...
                {/* <img src={this.state.data.image} alt="uploadedimage" /> */}
              </div>
              ...
              <button
                ...
                onClick={() => (window.location = "/RoomOwner/MyRooms")}
              >
                Cancel
              </button>
            </div>
